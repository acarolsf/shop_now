...
class _AuthCardState extends State<AuthCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      elevation: 8.0,
      child: Container(
        height: _authMode == AuthMode.Signup ? 520 : 660,
        constraints:
            BoxConstraints(minHeight: _authMode == AuthMode.Signup ? 520 : 660),
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                FlatButton(
                  child: Text(
                      '${_authMode == AuthMode.Login ? 'CADASTRAR' : 'ENTRAR'}'),
